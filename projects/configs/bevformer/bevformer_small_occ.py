...
bev_h_ = 150  # ORIGINAL: 150, DEB: 200
bev_w_ = 150  # ORIGINAL: 150, DEB: 200
...
train_pipeline = [
    ...
    dict(
        ...
        keys=["img", "voxel_semantics", "voxel_flow"]
    )
]
...
# # NOTE: The following eval_pipeline dict object is not
# # present in the BEVFormer (Base)-based OccNet model.
