...
def visualize_occ(points, labels, ego_dict):
    ...
    if add_ego_car:
        ...
        ego_pcd.points = o3d.utility.Vector3dVector(ego_dict['point'])
        ego_pcd.colors = o3d.utility.Vector3dVector(np.ones_like(ego_dict['point']))
...
def visualize_flow(points, labels, flow_values, flow_labels, ego_dict):
    ...
    fore_pcd.colors = o3d.utility.Vector3dVector(flow_colors_map[flow_colors] / 255.0)

    back_pcd = o3d.geometry.PointCloud()
    back_pcd.points = o3d.utility.Vector3dVector(back_points)
    back_pcd.colors = o3d.utility.Vector3dVector(np.stack([back_color] * 3, axis=-1))
    ...
    if add_ego_car:
        ...
        o3d.visualization.draw_geometries([fore_pcd, back_pcd, ego_pcd])
    else:
    ...
    for scene_name in os.listdir(data_dir):
        ...
        for index in range(image_num):
            ...
            if out_flow:
                ...
                visualize_flow(points, labels, flow_values, flow_labels, ego_dict)
